...
train = True
MODEL_NAME = '15_epochs_100_steps_retinanet_pretrained_model.h5'
...
'''
TRAIN
retinanet-train --freeze-backbone --batch-size 4 --steps 100 --weights '/home/group00/working/Antoni_THESIS/RETINANET/MODELS/15_epochs_retinanet_pretrained_model.h5' --epochs 15 csv ./train.csv ./classes.csv
